...
Vue.prototype.$mydata = {
    server: {
        ...
        action: {
            ...
            GET_USERS: 'users',
            GET_ROLES_WITH_PERMISSIONS: 'roles',
            GET_ROLES: 'only_roles',
            GET_STATS: 'stats'
        }
    },
    LOCAL_AUTH_CODES: {
    ...
    data: {
        ...
        stats: [],
        users: [],
        /*roles: [{"id":2,"name":"Администратор","description":"Может всё","permissions":[{"r":1,"w":1,"url_id":5},{"r":1,"w":1,"url_id":6},{"r":1,"w":1,"url_id":7},{"r":1,"w":1,"url_id":8},{"r":1,"w":1,"url_id":9},{"r":1,"w":1,"url_id":10},{"r":1,"w":1,"url_id":11}]},{"id":1,"name":"Администратор+","description":"Повелитель админов","permissions":[{"r":1,"w":1,"url_id":6},{"r":1,"w":1,"url_id":7},{"r":1,"w":1,"url_id":8},{"r":1,"w":1,"url_id":9},{"r":1,"w":1,"url_id":10},{"r":1,"w":1,"url_id":11},{"r":1,"w":1,"url_id":5}]},{"id":0,"name":"Пользователь","description":"Может только смотреть, но ничего не менять. Не имеет доступа к панели администратора","permissions":[{"r":1,"w":0,"url_id":5},{"r":1,"w":0,"url_id":6},{"r":1,"w":0,"url_id":7},{"r":1,"w":0,"url_id":8},{"r":1,"w":0,"url_id":9},{"r":1,"w":0,"url_id":10},{"r":0,"w":0,"url_id":11}]}, {"id":3,"name":"Админdwaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaистратор","description":"Может всё","permissions":[{"r":1,"w":1,"url_id":5},{"r":1,"w":1,"url_id":6},{"r":1,"w":1,"url_id":7},{"r":1,"w":1,"url_id":8},{"r":1,"w":1,"url_id":9},{"r":1,"w":1,"url_id":10},{"r":1,"w":1,"url_id":11}]}],
        urls: [{"id":5,"name":"Syncdata","path":"/syncdata/"},{"id":6,"name":"Графики","path":"/graphs/"},{"id":7,"name":"UNP","path":"/unp/"},{"id":8,"name":"Информация об устройствах","path":"/unp/info_teg.html"},{"id":9,"name":"Ошибки устройств","path":"/unp/info_dev_err.html"},{"id":10,"name":"Главная","path":"/"},{"id":11,"name":"Панель администратора","path":"/admin"}],
